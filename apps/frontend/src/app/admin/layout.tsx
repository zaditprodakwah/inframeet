    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex relative overflow-hidden font-sans">
      ...
      <aside className="w-64 bg-slate-900/60 border-r border-slate-800/80 backdrop-blur-xl flex flex-col relative z-20 shrink-0">
        ...
        <div className="p-4 border-t border-slate-800/60 flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center font-bold text-indigo-400 text-sm select-none">
            AD
          </div>

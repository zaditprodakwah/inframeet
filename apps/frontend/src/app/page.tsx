...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-300 font-sans selection:bg-indigo-500/30">
      ...
      <main className="flex-1 space-y-24 pb-24 relative overflow-hidden">
        ...
        <section className="relative pt-24 pb-16 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 text-center space-y-8 relative z-10">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-indigo-455 animate-pulse" />
              Mitra Arsitektur Digital &amp; Asistensi Riset Terakreditasi
            </span>

            {/* H1 Headline */}
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-[1.15] max-w-4xl mx-auto">
              Infrastruktur Kepercayaan <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-450 via-violet-400 to-emerald-450">Berbasis Bukti</span>.
            </h1>

            {/* H2 Sub-headline */}
            <h2 className="text-base md:text-lg text-slate-400 max-w-3xl mx-auto font-medium leading-relaxed">
            ...
            <div className="max-w-md mx-auto pt-2">
              <form
                action="/calculator"
                method="GET"
                className="flex items-center gap-2 p-1.5 rounded-2xl bg-white dark:bg-slate-950 border border-slate-900 focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-550 transition-all duration-300 shadow-md"
              >
                <input
                  type="email"
                  name="email"
                  ...
                  className="flex-1 px-4 py-3 bg-transparent text-sm text-white placeholder-slate-600 outline-none border-0"
                />
                <button
                  type="submit"
        ...
        {/* DYNAMIC TRUST INDICATOR BAR */}
        <section className="max-w-6xl mx-auto px-6 -mt-8 relative z-20 font-sans">
          <div className="glass-panel bg-white dark:bg-slate-950/40 border border-slate-900/80 rounded-3xl p-6 flex flex-wrap justify-around items-center gap-6 text-center shadow-sm">
            <div className="space-y-1">
              <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">1,200+</p>
            ...
            <div className="h-8 w-px bg-slate-100 dark:bg-slate-900 hidden md:block" />
            <div className="space-y-1">
              <p className="text-2xl font-black text-emerald-450 tracking-tight">100%</p>
              <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Anti-Joki &amp; Turnitin Safe</p>
            </div>
            <div className="h-8 w-px bg-slate-100 dark:bg-slate-900 hidden md:block" />
            <div className="space-y-1">
              <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">2 Jam</p>
        ...
        <section className="max-w-7xl mx-auto px-6 text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 hover:opacity-90 transition-all duration-300 py-3 text-xs font-extrabold text-slate-400">
        ...
        <section id="solusi-silo" className="max-w-7xl mx-auto px-6 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-3xl space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 text-indigo-455 flex items-center justify-center border border-indigo-500/20">
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between group">
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-indigo-400 transition-colors">
              ...
              <div className="pt-4 border-t border-slate-900/50 mt-6 flex justify-between items-center">
            ...
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between group">
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-emerald-455 transition-colors">
            ...
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between group">
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-amber-400 transition-colors">
              ...
              <div className="pt-4 border-t border-slate-900/50 mt-6 flex justify-between items-center">
                ...
                <Link href="/case-studies" className="text-xs font-bold text-amber-400 hover:text-amber-300 flex items-center gap-1 transition-colors">
        ...
        <section className="relative overflow-hidden py-12 max-w-7xl mx-auto px-6 font-sans">
          <div className="glass-panel bg-white dark:bg-slate-950/40 border border-slate-900/80 p-8 md:p-12 rounded-3xl flex flex-col md:flex-row gap-12 items-center shadow-sm">
            {/* Image Frame */}
            <div className="w-48 h-48 md:w-64 md:h-64 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-md shrink-0 relative group">
              <img
            ...
            <div className="space-y-6 flex-1">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <div className="px-4 py-2 rounded-xl bg-white dark:bg-slate-950 border border-slate-900 text-slate-350 shadow-sm flex items-center gap-1.5">
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest font-mono">Direktori Alat Terkurasi</span>
            <h3 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Tool 1 */}
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-900 text-slate-100 flex items-center justify-center font-bold text-sm border border-slate-200 dark:border-slate-800">
                    ▲
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-white">Vercel Hosting</h4>
              ...
              <div className="pt-4 border-t border-slate-900/50 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-emerald-450 font-bold">Free Tier</span>
            ...
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white">SmartPLS 4</h4>
                    <span className="text-[10px] font-semibold text-slate-550 flex items-center gap-1">
            ...
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-900 text-slate-100 flex items-center justify-center font-bold border border-slate-200 dark:border-slate-800">
                    <Database className="w-4 h-4 text-emerald-450" />
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-white">Supabase DB</h4>
                    <span className="text-[10px] font-semibold text-slate-550 flex items-center gap-1">
              ...
              <div className="pt-4 border-t border-slate-900/50 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-emerald-450 font-bold">B2B Base DB</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-400 hover:text-indigo-300">
                  Detail Tool
                </Link>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-slate-900 pb-6">
            ...
            <div className="flex gap-4">
              <Link href="/tools" className="text-xs font-bold text-slate-400 hover:text-indigo-400 flex items-center gap-1 transition-colors">
                <Search className="w-3.5 h-3.5" />
                Semua Tools
              </Link>
              <Link href="/insights" className="text-xs font-bold text-slate-400 hover:text-indigo-400 flex items-center gap-1 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {articlesToShow.map((art: any) => {
              ...
              return (
                <div key={art.id} className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl flex flex-col justify-between space-y-4">
                  <div className="space-y-3">
                    <span className="text-[9px] uppercase font-mono font-extrabold px-2 py-0.5 bg-indigo-550/10 text-indigo-400 rounded-full border border-indigo-500/20">
                  ...
                  <div className="pt-2 border-t border-slate-900/50 flex justify-between items-center text-[10px] text-slate-500">
                    <span>Source: {art.rss_feeds?.feed_name || "Expert Insights"}</span>
                    {isFallback ? (
                      <Link href="/insights" className="text-xs font-bold text-indigo-400 hover:text-indigo-300 flex items-center gap-0.5">
                        Baca Ulasan <ArrowRight className="w-3.5 h-3.5" />
                      </Link>
                    ) : (
                      <Link href={`/insights/${art.id}`} className="text-xs font-bold text-indigo-400 hover:text-indigo-300 flex items-center gap-0.5">
                        Baca Ulasan <ArrowRight className="w-3.5 h-3.5" />
                      </Link>
                    )}
                  </div>
        ...
        <section className="max-w-4xl mx-auto px-6 space-y-12">
          ...
          <div className="space-y-4">
            {/* FAQ 1 */}
            <div className="glass-card p-6 bg-white dark:bg-slate-950/40 border border-slate-900/80 shadow-md rounded-2xl space-y-3">
        ...
        <section className="max-w-4xl mx-auto px-6 text-center space-y-6 pt-12">
          ...
          <div>
            <Link
              href="/calculator"
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-slate-900 dark:text-white font-bold rounded-2xl transition shadow-md cursor-pointer"
            >
      ...
      {/* 11. FAT FOOTER */}
      <div className="border-t border-slate-900 mt-12 bg-white dark:bg-slate-950/20">
        <TrustBadges />
      </div>
      <Footer />
    </div>
...
function TrustBadges() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-6 py-8">
      <div className="glass-card bg-white dark:bg-slate-950/40 border border-slate-900/80 p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center shrink-0">
            <ShieldCheck className="w-5 h-5 text-indigo-400 shrink-0" />
          </div>
          <h4 className="text-sm font-bold text-white">100% Anti-Joki Policy</h4>
        </div>
        <p className="text-xs text-slate-455 leading-relaxed">
      ...
      <div className="glass-card bg-white dark:bg-slate-950/40 border border-slate-900/80 p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-sm font-bold text-white">SLA Respons 2 Jam</h4>
        </div>
        <p className="text-xs text-slate-455 leading-relaxed">
      ...
      <div className="glass-card bg-white dark:bg-slate-950/40 border border-slate-900/80 p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-sm font-bold text-white">Kepatuhan UU PDP</h4>
        </div>
        <p className="text-xs text-slate-455 leading-relaxed">
      ...
      <div className="glass-card bg-white dark:bg-slate-950/40 border border-slate-900/80 p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-sm font-bold text-white">Jaminan Kualitas UAT</h4>
        </div>
        <p className="text-xs text-slate-455 leading-relaxed">

...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-indigo-650/30">
      ...
      <main className="flex-1 space-y-24 pb-24">
        ...
        <section className="relative pt-24 pb-16 overflow-hidden bg-gradient-to-b from-indigo-50/40 via-white to-slate-50">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center space-y-8 relative z-10">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-755 border border-indigo-100 shadow-sm">
            ...
            <div className="max-w-md mx-auto pt-2">
              <form
                action="/calculator"
                method="GET"
                className="flex items-center gap-2 p-1.5 rounded-2xl bg-white border border-slate-200 focus-within:ring-2 focus-within:ring-indigo-650/20 focus-within:border-indigo-600 transition-all duration-300 shadow-md"
              >
                <input
                  type="email"
                  name="email"
                  ...
                  className="flex-1 px-4 py-3 bg-transparent text-sm text-slate-800 placeholder-slate-400 outline-none"
                />
                <button
                  type="submit"
              ...
              <p className="text-[10px] text-slate-500 mt-2 flex items-center justify-center gap-1 font-medium">
                <span className="text-indigo-600 font-bold">✓</span> Proteksi Data Terjamin. Email Anda otomatis mengisi draf brief di panel kalkulator.
              </p>
            </div>
        ...
        <section className="max-w-6xl mx-auto px-6 -mt-8 relative z-20 font-sans">
          <div className="glass-panel bg-white border border-slate-200/60 rounded-3xl p-6 flex flex-wrap justify-around items-center gap-6 text-center shadow-sm">
            <div className="space-y-1">
              <p className="text-2xl font-black text-slate-850 tracking-tight">1,200+</p>
              <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Sinyal Riset Dipantau (SLA 24j)</p>
            </div>
            <div className="h-8 w-px bg-slate-200 hidden md:block" />
            <div className="space-y-1">
              <p className="text-2xl font-black text-indigo-600 tracking-tight">Rp 0</p>
              <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Biaya Server Bulanan Klien SaaS</p>
            </div>
            <div className="h-8 w-px bg-slate-200 hidden md:block" />
            <div className="space-y-1">
              <p className="text-2xl font-black text-emerald-600 tracking-tight">100%</p>
              <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Anti-Joki &amp; Turnitin Safe</p>
            </div>
            <div className="h-8 w-px bg-slate-200 hidden md:block" />
            <div className="space-y-1">
              <p className="text-2xl font-black text-slate-850 tracking-tight">2 Jam</p>
              <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">SLA Respons Resolusi Kritis</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-40 grayscale hover:grayscale-0 hover:opacity-75 transition-all duration-300 py-3 text-xs font-extrabold text-slate-500">
        ...
        <section id="solusi-silo" className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest font-mono">Dua Pilar Solusi Utama</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8 bg-white border border-slate-200/60 shadow-sm rounded-3xl space-y-6 flex flex-col justify-between">
              ...
              <Link
                href="/layanan/b2b"
                className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-indigo-600 hover:text-indigo-750 hover:translate-x-1 transition-all"
              >
            ...
            <div className="glass-card p-8 bg-white border border-slate-200/60 shadow-sm rounded-3xl space-y-6 flex flex-col justify-between">
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-emerald-600 hover:text-emerald-750 hover:translate-x-1 transition-all"
              >
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest font-mono">Bukti Nyata Karya &amp; Solusi</span>
            <h3 className="text-3xl font-extrabold text-slate-900 tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between group">
              <div className="space-y-4">
                <span className="px-2 py-0.5 text-[9px] font-bold bg-indigo-50 text-indigo-700 rounded border border-indigo-100">B2B CLOUD IMPLEMENTATION</span>
                <h4 className="text-lg font-bold text-slate-900 group-hover:text-indigo-650 transition-colors">
              ...
              <div className="pt-4 border-t border-slate-200/50 mt-6 flex justify-between items-center">
                <span className="text-[10px] text-slate-500">Client: Agensi Retail</span>
                <Link href="/case-studies" className="text-xs font-bold text-indigo-600 hover:text-indigo-750 flex items-center gap-1 transition-colors">
            ...
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between group">
              <div className="space-y-4">
                <span className="px-2 py-0.5 text-[9px] font-bold bg-emerald-50 text-emerald-700 rounded border border-emerald-100">ACADEMIC RESEARCH MODELING</span>
                <h4 className="text-lg font-bold text-slate-900 group-hover:text-emerald-650 transition-colors">
              ...
              <div className="pt-4 border-t border-slate-200/50 mt-6 flex justify-between items-center">
                ...
                <Link href="/case-studies" className="text-xs font-bold text-emerald-600 hover:text-emerald-750 flex items-center gap-1 transition-colors">
                  Detail Studi Kasus <ArrowUpRight className="w-3.5 h-3.5" />
                </Link>
              </div>
            </div>
            ...
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between group">
              <div className="space-y-4">
                <span className="px-2 py-0.5 text-[9px] font-bold bg-amber-50 text-amber-700 rounded border border-amber-100">SCHOLARLY ARTICLE COMPLIANCE</span>
              ...
              <div className="pt-4 border-t border-slate-200/50 mt-6 flex justify-between items-center">
                ...
                <Link href="/portfolio" className="text-xs font-bold text-amber-600 hover:text-amber-750 flex items-center gap-1 transition-colors">
        ...
        <section className="relative overflow-hidden py-12 max-w-7xl mx-auto px-6 font-sans">
          ...
          <div className="glass-panel bg-white border border-slate-200/60 p-8 md:p-12 rounded-3xl flex flex-col md:flex-row gap-12 items-center shadow-sm">
            {/* Image Frame */}
            <div className="w-48 h-48 md:w-64 md:h-64 rounded-3xl overflow-hidden border border-slate-200 shadow-md shrink-0 relative group">
              <img
            ...
            <div className="space-y-6 flex-1">
              <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest font-mono">Principal Architect &amp; Founder</span>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <div className="px-4 py-2 rounded-xl bg-slate-50 border border-slate-200/50 text-xs font-semibold text-slate-650 flex items-center gap-1.5 shadow-sm">
                  <Cpu className="w-4 h-4 text-indigo-600 shrink-0" /> Cloud Native Systems
                </div>
                <div className="px-4 py-2 rounded-xl bg-slate-50 border border-slate-200/50 text-xs font-semibold text-slate-650 flex items-center gap-1.5 shadow-sm">
                  <TrendingUp className="w-4 h-4 text-emerald-600 shrink-0" /> SEM-PLS &amp; Quantitative Statistics
                </div>
                <div className="px-4 py-2 rounded-xl bg-slate-50 border border-slate-200/50 text-xs font-semibold text-slate-650 flex items-center gap-1.5 shadow-sm">
                  <Award className="w-4 h-4 text-amber-600 shrink-0" /> E-E-A-T Authority Auditing
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Tool 1 */}
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900">Vercel Hosting</h4>
              ...
              <div className="pt-4 border-t border-slate-200/50 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-emerald-600 font-bold">Free Tier</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-600 hover:text-indigo-750">
                  Detail Tool
                </Link>
              </div>
            </div>
            ...
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900">SmartPLS 4</h4>
                    <span className="text-[10px] font-semibold text-slate-500 flex items-center gap-1">
              ...
              <div className="pt-4 border-t border-slate-200/50 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-indigo-600 font-bold">Standard Riset</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-600 hover:text-indigo-750">
                  Detail Tool
                </Link>
              </div>
            ...
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900">Supabase DB</h4>
                    <span className="text-[10px] font-semibold text-slate-500 flex items-center gap-1">
              ...
              <div className="pt-4 border-t border-slate-200/50 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-emerald-600 font-bold">B2B Base DB</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-600 hover:text-indigo-750">
                  Detail Tool
                </Link>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-slate-200 pb-6">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-650 flex items-center gap-1.5 mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {articlesToShow.map((art: any) => {
              ...
              return (
                <div key={art.id} className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl flex flex-col justify-between space-y-4">
                  <div className="space-y-3">
                    <span className="text-[9px] uppercase font-mono font-extrabold px-2 py-0.5 bg-indigo-50 text-indigo-700 rounded-full border border-indigo-100">
                      {art.categories?.[0] || "EXPERT ANALYSIS"}
                    </span>
                    <h4 className="text-base font-bold text-slate-900 line-clamp-2 hover:text-indigo-600 transition-colors">
                      {isFallback ? (
                    ...
                    <div className="space-y-1.5 pt-2 border-t border-slate-200/50">
                      {summaryPoints.map((pt: string, i: number) => (
                        <p key={i} className="text-xs text-slate-550 line-clamp-2">
                          • {pt}
                        </p>
                      ))}
                    </div>
                  ...
                  <div className="pt-2 border-t border-slate-200/50 flex justify-between items-center text-[10px] text-slate-500">
                    ...
                    {isFallback ? (
                      <Link href="/insights" className="text-xs font-bold text-indigo-600 hover:text-indigo-750 flex items-center gap-0.5">
                        Baca Ulasan <ArrowRight className="w-3 h-3" />
                      </Link>
                    ) : (
                      <Link href={`/insights/${art.id}`} className="text-xs font-bold text-indigo-600 hover:text-indigo-750 flex items-center gap-0.5">
                        Baca Ulasan <ArrowRight className="w-3 h-3" />
                      </Link>
                    )}
                  </div>
        ...
        <section className="max-w-4xl mx-auto px-6 space-y-12">
          <div className="text-center space-y-4">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-650 flex items-center justify-center gap-1.5">
          ...
          <div className="space-y-4">
            {/* FAQ 1 */}
            <div className="glass-card p-6 bg-white border border-slate-200/60 shadow-sm rounded-2xl space-y-3">
        ...
        <section className="max-w-4xl mx-auto px-6 text-center space-y-6 pt-12">
          <div className="w-12 h-12 rounded-full bg-indigo-50 text-indigo-600 border border-indigo-100 flex items-center justify-center mx-auto">
            <Layers className="w-6 h-6 animate-pulse" />
          </div>
          <h3 className="text-2xl font-bold text-slate-900">Siap Merancang Solusi Anda?</h3>
...
function TrustBadges() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-6 py-8">
      <div className="glass-card bg-white border border-slate-200/60 shadow-sm p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center shrink-0">
            <ShieldCheck className="w-5 h-5 text-indigo-600 shrink-0" />
          </div>
          <h4 className="text-sm font-bold text-slate-900">100% Anti-Joki Policy</h4>
        </div>
        <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <div className="glass-card bg-white border border-slate-200/60 shadow-sm p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-sm font-bold text-slate-900">SLA Respons 2 Jam</h4>
        </div>
        <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <div className="glass-card bg-white border border-slate-200/60 shadow-sm p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-sm font-bold text-slate-900">Kepatuhan UU PDP</h4>
        </div>
        <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <div className="glass-card bg-white border border-slate-200/60 shadow-sm p-6 rounded-2xl flex flex-col justify-between space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-sm font-bold text-slate-900">Jaminan Kualitas UAT</h4>
        </div>
        <p className="text-xs text-slate-600 leading-relaxed">

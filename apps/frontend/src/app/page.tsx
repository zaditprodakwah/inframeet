      ...
      <main className="flex-1 space-y-24 pb-24">
        ...
        <section className="relative pt-24 pb-16 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center space-y-8 relative z-10">
            ...
            {/* H1 Headline */}
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 dark:text-zinc-50 tracking-tight leading-[1.15] max-w-4xl mx-auto">
            ...
            {/* H2 Sub-headline */}
            <h2 className="text-base md:text-lg text-slate-500 dark:text-zinc-400 max-w-3xl mx-auto font-normal leading-relaxed">
            ...
            <div className="max-w-md mx-auto pt-2">
              <form
                action="/calculator"
                method="GET"
                className="flex items-center gap-2 p-1.5 rounded-2xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-500 transition-all duration-300 shadow-xl shadow-indigo-500/[0.02]"
              >
                <input
                  type="email"
                  name="email"
                  ...
                  className="flex-1 px-4 py-3 bg-transparent text-sm text-slate-800 dark:text-slate-200 placeholder-slate-400 outline-none"
                />
                <button
                  type="submit"
              ...
              <p className="text-[10px] text-slate-400 dark:text-zinc-500 mt-2">
                🔒 Tanpa Spam. Email Anda otomatis mengisi draf brief di panel kalkulator.
              </p>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 text-center space-y-6">
          <p className="text-[10px] uppercase font-extrabold tracking-widest text-slate-400 dark:text-zinc-500">
            TEKNOLOGI DAN STANDAR AKREDITASI UTAMA
          </p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-40 grayscale hover:grayscale-0 hover:opacity-75 transition-all duration-300 py-3 text-xs font-extrabold text-slate-800 dark:text-zinc-300">
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-[#090d1f] border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900 mt-6 flex justify-between items-center">
                <span className="text-[10px] text-slate-400">Client: Agensi Retail</span>
                <Link href="/case-studies" className="text-xs font-bold text-indigo-400 hover:text-indigo-300 flex items-center gap-1">
            ...
            <div className="bg-white dark:bg-[#090d1f] border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900 mt-6 flex justify-between items-center">
                <span className="text-[10px] text-slate-400">Client: Peneliti FEB S2</span>
                <Link href="/case-studies" className="text-xs font-bold text-emerald-400 hover:text-emerald-300 flex items-center gap-1">
                  Detail Studi Kasus <ArrowUpRight className="w-3.5 h-3.5" />
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#090d1f] border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900 mt-6 flex justify-between items-center">
                <span className="text-[10px] text-slate-400">Client: Dosen Universitas</span>
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 flex flex-col justify-between shadow-sm hover:border-indigo-500/20 transition duration-300">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100">Vercel Hosting</h4>
                    <span className="text-[10px] font-semibold text-slate-400">⭐ 4.9 (42 Ulasan)</span>
                  </div>
                </div>
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-emerald-500 font-bold">Free Tier</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-500 hover:text-indigo-400">
                  Detail Tool
                </Link>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 flex flex-col justify-between shadow-sm hover:border-indigo-500/20 transition duration-300">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100">SmartPLS 4</h4>
                    <span className="text-[10px] font-semibold text-slate-400">⭐ 4.8 (31 Ulasan)</span>
                  </div>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-indigo-500 font-bold">Standard Riset</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-500 hover:text-indigo-400">
                  Detail Tool
                </Link>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 flex flex-col justify-between shadow-sm hover:border-indigo-500/20 transition duration-300">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100">Supabase DB</h4>
                    <span className="text-[10px] font-semibold text-slate-400">⭐ 4.9 (29 Ulasan)</span>
                  </div>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900 mt-6 flex items-center justify-between">
                <span className="text-[10px] font-mono text-emerald-500 font-bold">B2B Base DB</span>
                <Link href="/tools" className="text-xs font-bold text-indigo-500 hover:text-indigo-400">
                  Detail Tool
                </Link>
              </div>
              ...
              return (
                <div key={art.id} className="bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col justify-between space-y-4 hover:border-indigo-500/20 transition duration-300">
                  <div className="space-y-3">
                    ...
                    <h4 className="text-base font-bold text-slate-900 dark:text-zinc-50 line-clamp-2 hover:text-indigo-400 transition-colors">
                      {isFallback ? (
                    ...
                    <div className="space-y-1.5 pt-2 border-t border-slate-100 dark:border-zinc-900">
                      {summaryPoints.map((pt: string, i: number) => (
                        <p key={i} className="text-xs text-slate-500 dark:text-zinc-400 line-clamp-2">
                          • {pt}
                        </p>
                      ))}
                    </div>
                  </div>
                  <div className="pt-2 border-t border-slate-100 dark:border-zinc-900 flex justify-between items-center text-[10px] text-slate-400">
        ...
        <section className="max-w-4xl mx-auto px-6 space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm space-y-3">
              ...
              <p className="text-sm text-slate-500 dark:text-zinc-400 leading-relaxed">
                INFRAMEET adalah mitra kemitraan digital B2B premium dan asistensi riset akademik kuantitatif. Kami membantu korporasi memigrasikan sistem server mereka ke cloud serverless bebas biaya bulanan, serta memandu peneliti dalam pemenuhan standar ilmiah dan komputasi statistik secara steril.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm space-y-3">
              ...
              <p className="text-sm text-slate-500 dark:text-zinc-400 leading-relaxed">
                Sama sekali TIDAK. INFRAMEET berkomitmen tinggi menjunjung integritas akademik. Kami melarang keras segala bentuk perjokian naskah. Seluruh instrumen bantuan kami murni ditujukan untuk asistensi teknis olah data statistik (SPSS/SEM), layouting naskah, format presentasi, and pengecekan plagiarisme Turnitin secara transparan.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-slate-100 dark:border-zinc-900 pb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs font-semibold text-slate-600 dark:text-zinc-400">
              ...
              <li><Link href="/insights" className="hover:text-indigo-600 transition-colors">Analisis &amp; Ulasan Riset</Link></li>

    ...
    <div className="min-h-screen bg-background text-foreground antialiased font-sans selection:bg-[#6366f1]/30 transition-colors duration-300">
      ...
      <main className="pt-28 pb-16">
        ...
        <section className="relative min-h-[640px] flex flex-col justify-center items-center px-4 md:px-10 overflow-hidden">
          ...
          >
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-[#6366f1]/10 text-[#6366f1] text-[#c0c1ff] border border-[#6366f1]/20 shadow-sm font-mono-technical">
              <Sparkles className="w-3.5 h-3.5 text-[#6366f1] animate-pulse" />
              Mitra Arsitektur Digital &amp; Asistensi Riset Terakreditasi
            </span>

            <h1 className="hero-title font-sans text-4xl md:text-6xl text-glow">
            ...
            <div className="max-w-md mx-auto pt-2">
              ...
              >
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-transparent text-sm text-white placeholder-slate-400 dark:placeholder-[#908fa0] outline-none border-none focus:ring-0"
                />
                <button
                  type="submit"
              ...
              <p className="text-[10px] text-slate-500 text-[#908fa0] mt-2.5 flex items-center justify-center gap-1.5">
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-10 py-16">
          ...
          >
            ...
            >
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <GraduationCap className="w-5 h-5 text-[#6366f1] text-[#c0c1ff]" />
                  <span className="font-mono text-xs text-[#6366f1] text-[#c0c1ff] uppercase tracking-wider">Academic Support</span>
                </div>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-10 py-16 space-y-12">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-slate-200 border-white/5 pb-6">
            <div>
              ...
              return (
                <div key={art.id} className="glass-panel p-6 rounded-2xl flex flex-col justify-between space-y-4 hover:border-[#6366f1]/30 transition-colors duration-300">
                  <div className="space-y-3">
                    <span className="text-[10px] uppercase font-mono font-bold px-2 py-0.5 bg-[#6366f1]/10 text-[#6366f1] text-[#c0c1ff] rounded border border-[#6366f1]/20">
                    ...
                    <div className="space-y-1.5 pt-2 border-t border-slate-200 border-white/5">
                  ...
                  <div className="pt-3 border-t border-slate-200 border-white/5 flex justify-between items-center text-[10px] text-slate-500 text-[#908fa0] font-mono">
            ...
            <div className="glass-panel p-6 rounded-3xl relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-6 relative z-10">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-bold text-white text-lg">Dasbor Pemantauan (Klien B2B)</h4>
                </div>
            ...
            <div className="glass-panel p-6 rounded-3xl relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-6 relative z-10">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-bold text-white text-lg">Embed Widget &amp; Lencana SEO</h4>
                </div>
              </div>

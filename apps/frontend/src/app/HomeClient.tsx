...
export default function HomeClient({ articles, topDirectories = [], topExperts = [] }: HomeClientProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased font-sans selection:bg-[#6366f1]/30 transition-colors duration-300">
      ...
      <main className="pt-28 pb-16">
        ...
        <section className="relative min-h-[640px] flex flex-col justify-center items-center px-4 md:px-10 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,rgba(99,102,251,0.15)_0%,var(--background)_75%)] pointer-events-none" />
          ...
          >
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-[#6366f1]/10 text-[#6366f1] dark:text-[#c0c1ff] border border-[#6366f1]/20 shadow-sm font-mono-technical">
              <Sparkles className="w-3.5 h-3.5 text-[#6366f1] animate-pulse" />
              Mitra Arsitektur Digital &amp; Asistensi Riset Terakreditasi
            </span>

            <h1 className="font-sans text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
            ...
            <p className="text-base md:text-lg text-slate-600 dark:text-[#c7c4d7] max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="max-w-md mx-auto pt-2">
              <form
                ...
                className="flex items-center gap-2 p-1.5 rounded-xl bg-slate-100/85 dark:bg-[#101415]/80 border border-slate-200 dark:border-[#464554]/40 focus-within:border-[#6366f1] focus-within:ring-1 focus-within:ring-[#6366f1]/30 transition-all duration-300"
              >
                <input
                  type="email"
                  value={emailInput}
                  ...
                  className="flex-1 px-4 py-3 bg-transparent text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-[#908fa0] outline-none border-none focus:ring-0"
                />
                <button
                  type="submit"
                  className="px-5 py-3 bg-[#6366f1] hover:bg-[#8083ff] text-white text-xs font-bold font-mono-technical uppercase tracking-wider rounded-lg transition-colors flex items-center gap-1.5 shrink-0 cursor-pointer"
                >
                  Konsultasi Gratis <ArrowRight className="w-3.5 h-3.5" />
                </button>
              </form>
              <p className="text-[10px] text-slate-500 dark:text-[#908fa0] mt-2.5 flex items-center justify-center gap-1.5">
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-10 py-16">
          ...
          >
            ...
            <motion.div 
              ...
              className="md:col-span-8 glass-panel rounded-2xl p-8 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="relative z-10 max-w-lg">
                ...
                <p className="text-sm md:text-base text-slate-650 dark:text-[#c7c4d7] leading-relaxed">
              ...
              <div className="mt-8 relative z-10 flex gap-4">
                <div className="bg-slate-100/60 dark:bg-[#1d2022]/60 p-4 rounded-xl border border-slate-200 dark:border-white/5">
                  <div className="font-mono text-xs text-slate-500 dark:text-[#c7c4d7] mb-1">P99 Latency</div>
                  <div className="text-xl md:text-2xl font-bold text-[#6366f1] dark:text-[#c0c1ff] font-mono-technical">12ms</div>
                </div>
                <div className="bg-slate-100/60 dark:bg-[#1d2022]/60 p-4 rounded-xl border border-slate-200 dark:border-white/5">
                  <div className="font-mono text-xs text-slate-500 dark:text-[#c7c4d7] mb-1">Uptime SLA</div>
            ...
            >
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <GraduationCap className="w-5 h-5 text-[#6366f1] dark:text-[#c0c1ff]" />
                  <span className="font-mono text-xs text-[#6366f1] dark:text-[#c0c1ff] uppercase tracking-wider">Academic Support</span>
                </div>
                <h2 className="text-xl md:text-2xl font-extrabold text-slate-900 dark:text-white mb-4">
                  Integrity &amp; Validation
                </h2>
                <p className="text-sm text-slate-650 dark:text-[#c7c4d7] leading-relaxed mb-6">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs text-slate-750 dark:text-white font-mono-technical">Cryptographic Hashing</span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#4edea3] shrink-0" />
                    <span className="text-xs text-slate-750 dark:text-white font-mono-technical">Plagiarism Sandbox</span>
                  </li>
                </ul>
              </div>
              ...
              <Link 
                ...
                className="w-full bg-slate-200 hover:bg-slate-300 dark:bg-[#323537] dark:hover:bg-[#464554] border border-slate-300 dark:border-[#464554]/80 text-slate-800 dark:text-white font-mono text-xs py-3.5 rounded-lg transition-colors text-center uppercase tracking-wider cursor-pointer"
              >
                Verify Dataset
              </Link>
            </motion.div>
            ...
            <motion.div 
              variants={itemVariants}
              className="md:col-span-12 glass-panel rounded-2xl p-8"
            >
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white">Global Verification Network</h2>
                </div>
                
                <div className="flex items-center gap-2 bg-slate-100 dark:bg-[#0b0f10] px-4 py-2 rounded-full border border-slate-200 dark:border-white/5 font-mono text-xs text-slate-750 dark:text-slate-300">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                {/* Node Heatmap Area */}
                <div className="lg:col-span-6 bg-slate-100/90 dark:bg-[#0b0f10]/80 rounded-2xl p-6 border border-slate-200 dark:border-white/5 relative overflow-hidden flex flex-col justify-between group min-h-[300px]">
                  {/* Glowing Map Overlay */}
                  ...
                  <div className="relative z-10">
                    <h3 className="font-mono text-xs text-slate-800 dark:text-white uppercase tracking-wider mb-2">Node Distribution Heatmap</h3>
                    <p className="text-xs text-slate-600 dark:text-[#c7c4d7]">Global active verification instances with live SHA-256 signatures.</p>
                  </div>

                  <div className="relative z-10 flex gap-4 mt-auto">
                    <div className="bg-slate-200/95 dark:bg-[#101415]/95 border border-slate-300 dark:border-white/10 p-4 rounded-xl flex-1">
                      <div className="text-[10px] text-slate-500 dark:text-[#c7c4d7] mb-1 font-mono">Region: US East</div>
                      <div className="text-xs font-bold text-[#6366f1] dark:text-[#c0c1ff] font-mono-technical">Verified: 0x4F8a...</div>
                    </div>
                    <div className="bg-slate-200/95 dark:bg-[#101415]/95 border border-slate-300 dark:border-white/10 p-4 rounded-xl flex-1">
                      <div className="text-[10px] text-slate-500 dark:text-[#c7c4d7] mb-1 font-mono">Region: EU Central</div>
        ...
        </section>        {/* LATEST VERIFIED INSIGHTS FEED */}
        <section className="max-w-7xl mx-auto px-4 md:px-10 py-16 space-y-12">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-slate-200 dark:border-white/5 pb-6">
            <div>
            ...
            <div className="flex gap-4 font-mono text-xs">
              <Link href="/directory" className="text-slate-650 dark:text-[#c7c4d7] hover:text-[#6366f1] transition-colors flex items-center gap-1">
                Jaringan Pakar &rarr;
              </Link>
              <Link href="/insights" className="text-slate-650 dark:text-[#c7c4d7] hover:text-[#6366f1] transition-colors flex items-center gap-1">
                Semua Insights &rarr;
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {articles.slice(0, 3).map((art) => {
              ...
              return (
                <div key={art.id} className="glass-panel p-6 rounded-2xl flex flex-col justify-between space-y-4 hover:border-[#6366f1]/30 transition-colors duration-300">
                  <div className="space-y-3">
                    <span className="text-[10px] uppercase font-mono font-bold px-2 py-0.5 bg-[#6366f1]/10 text-[#6366f1] dark:text-[#c0c1ff] rounded border border-[#6366f1]/20">
                      {art.categories?.[0] || 'EXPERT ANALYSIS'}
                    </span>
                    <h4 className="text-base font-bold text-slate-900 dark:text-white line-clamp-2 hover:text-[#6366f1] transition-colors">
                      {isFallback ? (
                    ...
                    <div className="space-y-1.5 pt-2 border-t border-slate-200 dark:border-white/5">
                      {summaryPoints.map((pt, i) => (
                        <p key={i} className="text-xs text-slate-600 dark:text-[#c7c4d7]">
                          • {pt}
                        </p>
                      ))}
                    </div>
                  ...
                  <div className="pt-3 border-t border-slate-200 dark:border-white/5 flex justify-between items-center text-[10px] text-slate-500 dark:text-[#908fa0] font-mono">
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-10 py-16">
          <div className="glass-panel p-8 md:p-12 rounded-2xl flex flex-col md:flex-row gap-10 md:gap-12 items-center">
            {/* Founder Photo Frame */}
            <div className="w-48 h-48 md:w-64 md:h-64 rounded-2xl overflow-hidden border border-slate-200 dark:border-white/10 shadow-lg shrink-0 relative group">
              <img
            ...
            <div className="space-y-6 flex-1 text-center md:text-left">
              ...
              <p className="text-sm text-slate-650 dark:text-[#c7c4d7] leading-relaxed">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3 pt-2">
                <div className="px-3.5 py-2 rounded-lg bg-slate-100 dark:bg-[#0b0f10] border border-slate-200 dark:border-white/5 text-xs text-slate-700 dark:text-[#c7c4d7] font-mono-technical flex items-center gap-1.5">
          ...
          <div className="space-y-4">
            {[
              ...
              >
                <button
                  onClick={() => toggleFaq(i)}
                  className="w-full px-6 py-5 text-left flex justify-between items-center text-slate-900 dark:text-white font-bold text-sm md:text-base cursor-pointer hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
                >
                  <span>{faq.q}</span>
                  <ChevronDown className={`w-4 h-4 text-slate-500 dark:text-[#908fa0] transition-transform duration-300 ${activeFaq === i ? 'rotate-180' : ''}`} />
                </button>
                ...
                <AnimatePresence initial={false}>
                  {activeFaq === i && (
                    ...
                    >
                      <div className="px-6 pb-6 text-sm text-slate-650 dark:text-[#c7c4d7] leading-relaxed border-t border-slate-200 dark:border-white/5 pt-4">
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
        ...
        <section className="max-w-3xl mx-auto px-4 text-center space-y-6 pt-12">
          ...
          <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Siap Merancang Solusi Anda?</h3>
          <p className="text-sm text-slate-650 dark:text-[#c7c4d7] max-w-lg mx-auto leading-relaxed">
          ...
          <div>
            <Link
              href="/calculator"
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#6366f1] hover:bg-[#8083ff] text-white font-bold rounded-xl transition-colors cursor-pointer"
            >
      ...
      <div className="border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-[#0b0f10]/80">
        {/* Verification Seals grid */}
        <div className="max-w-7xl mx-auto px-4 md:px-10 py-6 grid grid-cols-2 md:grid-cols-4 gap-6 font-mono text-[10px] text-slate-500 dark:text-[#908fa0]">
          <div className="flex items-center gap-2">

...
export default function ExpertProfileClient({ expert, achievements }: ExpertProfileClientProps) {
  ...
  return (
    <div className="min-h-screen bg-[#070a0b] text-[#c7c4d7] flex flex-col justify-between selection:bg-indigo-650/30 font-sans">
      <div>
        {/* Navigation */}
        <MegaMenu />
        ...
        <div className="max-w-7xl mx-auto px-6 pt-28 pb-20 space-y-8 select-none">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Detailed Bio Card */}
              <div className="p-6 md:p-8 rounded-3xl border dark:border-white/5 bg-[#0b0f10]/80 relative overflow-hidden space-y-4 shadow-sm">
                <h3 className="text-base font-black tracking-wider uppercase text-white flex items-center gap-2">
              ...
              {/* Achievements Column */}
              <div className="p-6 md:p-8 rounded-3xl border dark:border-white/5 bg-[#0b0f10]/80 space-y-4 shadow-sm">
                <h3 className="text-base font-black tracking-wider uppercase text-white flex items-center gap-2">
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              {/* Trust Card */}
              <div className="p-6 rounded-3xl border dark:border-emerald-500/20 bg-emerald-950/10 relative overflow-hidden space-y-3 shadow-sm">
                <h5 className="text-xs font-black tracking-wide text-emerald-450 uppercase flex items-center gap-1.5 font-mono">
      ...
      {/* Footer */}
      <footer className="bg-[#070a0b] border-t dark:border-white/5 py-12 select-none">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-slate-500">
          <div className="flex items-center gap-2">
            <span className="font-extrabold tracking-widest text-white">INFRAMEET</span>

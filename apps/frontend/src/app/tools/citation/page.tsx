      ...
      <main className="max-w-7xl mx-auto px-6 py-12 pt-24 lg:pt-32">
            ...
            <section className="glass-panel p-8 rounded-3xl bg-[#0b0f10]/80 border border-white/5 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center h-[52px] px-4 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-xl cursor-pointer hover:border-indigo-500 transition-colors">
                    <span className="text-sm font-medium text-slate-700 dark:text-slate-300 flex-1">Include Abstract Summary</span>
          ...
          <div className="lg:col-span-5 space-y-8">
            <section className="glass-panel p-8 rounded-3xl h-full bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-500/20 shadow-xl flex flex-col">
              ...
              <div className="bg-white dark:bg-black/50 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-500/20 min-h-[200px] mb-8 relative group shadow-inner flex-1">
                <div className="font-mono text-sm leading-relaxed text-slate-900 dark:text-slate-200">
              ...
              <div className="space-y-6 mt-auto">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button className="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 py-4 rounded-xl border border-slate-200 dark:border-slate-700 font-mono text-[10px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all active:scale-95 shadow-sm">
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-panel p-6 rounded-2xl bg-slate-50/50 dark:bg-slate-900/20 border-2 border-dashed border-slate-300 dark:border-slate-700 flex flex-col items-center justify-center text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-400 transition-all cursor-pointer group min-h-[160px]">

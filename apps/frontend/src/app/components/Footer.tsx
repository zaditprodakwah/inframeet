...
export default function Footer() {
  return (
    <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 select-none py-16">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="space-y-4 lg:col-span-1">
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            <span className="text-[10px] font-black text-slate-400 tracking-wider font-mono uppercase">Node Active</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-[11px]">
            <li>
              <Link href="/layanan/b2b" className="hover:text-indigo-400 transition-colors">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-[11px]">
            <li>
              <Link href="/layanan/akademik" className="hover:text-indigo-400 transition-colors">
            ...
            <li>
              <Link href="/tools/institusi" className="hover:text-indigo-400 transition-colors">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-[11px]">
            ...
            <li>
              <Link href="/case-studies" className="hover:text-indigo-400 transition-colors">
                Studi Kasus Proyek
              </Link>
            </li>
            <li>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-slate-600">
        <div>
          &copy; {new Date().getFullYear()} INFRAMEET Integrity Infrastructure. Seluruh Hak Cipta Dilindungi.
        </div>
        <div className="flex gap-4">
          <span className="hover:text-slate-500 cursor-pointer">Syarat &amp; Ketentuan</span>
          <span>&middot;</span>
          <span className="hover:text-slate-500 cursor-pointer">Kebijakan Privasi</span>
          <span>&middot;</span>
          <span className="hover:text-slate-500 cursor-pointer">Academic Integrity &amp; Ethical Research Protocol</span>
        </div>
      </div>
    </footer>
  );

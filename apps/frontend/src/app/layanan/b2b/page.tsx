          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 z-10">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link
                  href="/legal"
                  className="glass-panel px-6 py-3 rounded-xl text-white font-medium hover:bg-slate-100 dark:hover:bg-white/5 transition-all flex items-center gap-2 cursor-pointer"
                >
            ...
            <div className="relative h-[300px] md:h-[400px] w-full rounded-2xl glass-panel overflow-hidden flex items-center justify-center border border-slate-200 dark:border-[#6366f1]/20 shadow-[0_0_40px_rgba(192,193,255,0.1)] bg-slate-50 dark:bg-transparent">
              <div className="z-10 text-center space-y-4">
                ...
                <div className="font-mono text-xs text-white bg-white/90 dark:bg-[#101415]/80 backdrop-blur px-4 py-2 rounded-xl border border-slate-200 dark:border-white/10">
                  SYS_ARCH_NODE_X9
                </div>
              </div>
            </div>

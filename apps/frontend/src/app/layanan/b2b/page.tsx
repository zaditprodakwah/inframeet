      ...
      <main className="flex-grow pt-8 pb-16 max-w-7xl mx-auto px-4 md:px-10 space-y-16">
        ...
        <section className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full dark:bg-[#1d2022]/60 border dark:border-white/10">
              ...
              <p className="text-sm md:text-base dark:text-[#c7c4d7] leading-relaxed max-w-xl">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link
                  href="/legal"
                  className="glass-panel px-6 py-3 rounded-xl text-white font-medium dark:hover:bg-white/5 transition-all flex items-center gap-2 cursor-pointer"
                >
              ...
              <div className="mt-8 pt-8 border-t dark:border-white/10 flex gap-8">
                <div>
                  <div className="font-mono text-xs text-[#6366f1] dark:text-[#c0c1ff] mb-1">UPTIME SLA</div>
                  <div className="text-xl md:text-2xl font-bold text-white">99.999%</div>
                </div>
                <div>
                  <div className="font-mono text-xs text-[#6366f1] dark:text-[#c0c1ff] mb-1">GLOBAL LATENCY</div>
                  <div className="text-xl md:text-2xl font-bold text-white">&lt; 50ms</div>
                </div>
              </div>
            </div>

            {/* Technical System Diagram Abstract */}
            <div className="relative h-[300px] md:h-[400px] w-full rounded-2xl glass-panel overflow-hidden flex items-center justify-center border dark:border-[#6366f1]/20 shadow-[0_0_40px_rgba(192,193,255,0.1)] dark:bg-transparent">
              <div className="z-10 text-center space-y-4">
                <Globe className="w-16 h-16 text-[#6366f1] dark:text-[#c0c1ff] mx-auto animate-spin-slow opacity-80" />
                <div className="font-mono text-xs text-white dark:bg-[#101415]/80 backdrop-blur px-4 py-2 rounded-xl border dark:border-white/10">
                  SYS_ARCH_NODE_X9
                </div>
              </div>
            </div>
        ...
        <section className="space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white">Enterprise-Grade Stack</h2>
            <p className="text-sm dark:text-[#c7c4d7] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300 min-h-[300px]">
              <div>
                <div className="w-12 h-12 rounded-xl dark:bg-[#101415] flex items-center justify-center mb-6 border dark:border-white/5">
                  <Database className="w-6 h-6 text-[#6366f1] dark:text-[#c0c1ff]" />
                </div>
                <h3 className="text-lg md:text-xl font-bold text-white mb-3">Supabase DB Integration</h3>
                <p className="text-sm dark:text-[#c7c4d7]">
              ...
              <div className="mt-8 border-t dark:border-white/10 pt-4 flex items-center justify-between">
            ...
            <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300 min-h-[300px]">
              <div>
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-3">Vercel Edge Deployment</h3>
                <p className="text-sm dark:text-[#c7c4d7]">
            ...
            <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300 min-h-[300px]">
              <div>
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-3">Core Web Vitals Audit</h3>
                <p className="text-sm dark:text-[#c7c4d7]">

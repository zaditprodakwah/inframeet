    ...
    <div className="flex flex-col min-h-screen bg-[#020617] text-slate-100 font-sans transition-colors duration-300">
      ...
      <main className="flex-grow py-12 space-y-16">
        ...
        <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="rounded-3xl border border-slate-800 bg-slate-900/40 backdrop-blur-md p-8 space-y-5 hover:border-indigo-500/20 transition-all duration-300">
        ...
        <section className="max-w-4xl mx-auto px-6">
          <div className="bg-indigo-900/60 border border-indigo-500/20 text-white rounded-3xl p-8 md:p-12 shadow-xl relative overflow-hidden text-center space-y-6">
            ...
            <div className="pt-2">
              <Link
                href="/calculator"
                className="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl transition-all shadow-lg cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
              >

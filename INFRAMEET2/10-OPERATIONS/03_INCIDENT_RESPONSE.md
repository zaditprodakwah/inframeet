# INFRAMEET - Flagged Content & Fraud Resolution SOP

Guidelines to resolve user disputes, fake reviews, and fraudulent directory entries.
...
## Incident: Fraudulent Claim Discovered
1. Lock the disputed directory listing by changing `verification_status = 'flagged'`.
2. Revoke the `owner_id` assigned to the listing.
3. Open an investigation ticket in the support queue.
